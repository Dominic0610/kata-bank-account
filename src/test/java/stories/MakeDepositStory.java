...
import stories.steps.MakeDepositSteps;

import java.text.SimpleDateFormat;
import java.util.List;

public class MakeDepositStory extends JUnitStory {
    ...
    public List<CandidateSteps> candidateSteps() {
        return new InstanceStepsFactory(configuration(), new MakeDepositSteps()).createCandidateSteps();
    }
